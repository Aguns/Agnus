...
<app id="appRoot">
    ...
    <div>
        <p class="appreciation-tag">
            ...
            <a href="https://dribbble.com/shots/3720358-Daily-Ui-025-TV-app" target="_blank">daily dribble</a>
        </p>
        <a href="https://hackernoon.com/building-a-movie-app-interface-with-vue-js-cdc8aeb5db0b" target="_blank" class="medium-section button is-small">
